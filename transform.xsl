                                ...
                                italics
									...
									<div id="areaAnnotations">
										...
										<xsl:for-each select="l">
											...
											<xsl:variable name="wratio"/>
											<xsl:value-of select="$naturalwidth div $origwidth"/>
											<xsl:variable name="hratio">
											<xsl:value-of select="$naturalheight div $origheight"/></xsl:variable>	
